// src/modules/ServicioTecnico/forms/estacionario/VoltajeAmperajeForm.jsx
import { Zap } from 'lucide-react';
import { Voltaje_Amperaje } from '../Data.js';
...
const VoltajeAmperajeForm = ({
    data = {},
    onChange
}) => {
    const campos = Array.isArray(Voltaje_Amperaje)
        ? Voltaje_Amperaje
        : [];
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500">
                        Registre las mediciones eléctricas del equipo.
                    </p>
                </div>
            </div>
            ...
            {campos.length === 0 ? (
                <div className="mt-5 rounded-lg border border-dashed border-slate-300 bg-slate-50 p-6 text-center">
                    <p className="text-sm text-slate-500">
                        No existen campos configurados para voltaje y amperaje.
                    </p>
                </div>
            ) : (
...
export default VoltajeAmperajeForm;